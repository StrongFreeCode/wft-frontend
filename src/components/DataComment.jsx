  ...
  return (
    <div className="mb-16">
      ...
      <div className="">
        <p className="text-xl">
          “{shortText}”
          <span className="justify-end text-blue-700 dark:text-blue-300 underline hover:text-slate-800"><button aria-label="OpenModal" onClick={() => setOpenModal(true)} className="bg-transparent ">
